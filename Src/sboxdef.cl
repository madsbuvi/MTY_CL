...
{\
 uint32_t x55005500, x5A0F5A0F, x3333FFFF, x66666666, x22226666, x2D2D6969,\
     x25202160;\
 uint32_t x00FFFF00, x33CCCC33, x4803120C, x2222FFFF, x6A21EDF3, x4A01CC93;\
 uint32_t x5555FFFF, x7F75FFFF, x00D20096, x7FA7FF69;\
 uint32_t x0A0A0000, x0AD80096, x00999900, x0AD99996;\
 uint32_t x22332233, x257AA5F0, x054885C0, xFAB77A3F, x2221EDF3, xD89697CC;\
 uint32_t x05B77AC0, x05F77AD6, x36C48529, x6391D07C, xBB0747B0;\
 uint32_t x4C460000, x4EDF9996, x2D4E49EA, xBBFFFFB0, x96B1B65A;\
 uint32_t x5AFF5AFF, x52B11215, x4201C010, x10B0D205;\
 uint32_t x00, x01, x10, x11, x20, x21, x30, x31;\
\
 x55005500 = a1 & ~a5;\
...
{\
 uint32_t x33CC33CC;\
 uint32_t x55550000, x00AA00FF, x33BB33FF;\
 uint32_t x33CC0000, x11441144, x11BB11BB, x003311BB;\
 uint32_t x00000F0F, x336600FF, x332200FF, x332200F0;\
 uint32_t x0302000F, xAAAAAAAA, xA9A8AAA5, x33CCCC33, x33CCC030, x9A646A95;\
 uint32_t x00333303, x118822B8, xA8208805, x3CC3C33C, x94E34B39;\
 uint32_t x0331330C, x3FF3F33C, xA9DF596A, xA9DF5F6F, x962CAC53;\
 uint32_t xA9466A6A, x3DA52153, x29850143, x33C0330C, x1A45324F;\
 uint32_t x0A451047, xBBDFDD7B, xB19ACD3C;\
 uint32_t x00, x01, x10, x11, x20, x21, x30, x31;\
\
 x33CC33CC = a2 ^ a5;\
\
...
{\
 uint32_t x44444444, x0F0FF0F0, x4F4FF4F4, x00FFFF00, x00AAAA00, x4FE55EF4;\
 uint32_t x3C3CC3C3, x3C3C0000, x7373F4F4, x0C840A00;\
 uint32_t x00005EF4, x00FF5EFF, x00555455, x3C699796;\
 uint32_t x000FF000, x55AA55AA, x26D9A15E, x2FDFAF5F, x2FD00F5F;\
 uint32_t x55AAFFAA, x28410014, x000000FF, x000000CC, x284100D8;\
 uint32_t x204100D0, x3C3CC3FF, x1C3CC32F, x4969967A;\
 uint32_t x3F3F3F3F, xB01AA10B, xBF3FBF3F, x83037CFC, xD6A98356;\
 uint32_t x001A000B, x3C73979D, xBF73FFFD, x0D2DD23E, xB25E2DC3;\
 uint32_t x00, x01, x10, x11, x20, x21, x30, x31;\
 x44444444 = a1 & ~a2;\
 x0F0FF0F0 = a3 ^ a6;\
...
{\
 uint32_t x5A5A5A5A, x0F0FF0F0;\
 uint32_t x33FF33FF, x33FFCC00, x0C0030F0, x0C0CC0C0, x0CF3C03F, x5EFBDA7F,\
     x52FBCA0F, x61C8F93C;\
 uint32_t x00C0C03C, x0F0F30C0, x3B92A366, x30908326, x3C90B3D6;\
 uint32_t x33CC33CC, x0C0CFFFF, x379E5C99, x04124C11, x56E9861E, xA91679E1;\
 uint32_t x9586CA37, x8402C833, x84C2C83F, xB35C94A6;\
 uint32_t x00, x01, x10, x11, x20, x21, x30, x31;\
 x5A5A5A5A = a1 ^ a3;\
 x0F0FF0F0 = a3 ^ a5;\
 x33FF33FF = a2 | a4;\
...
{\
 uint32_t x77777777, x77770000, x22225555, x11116666, x1F1F6F6F;\
 uint32_t x70700000, x43433333, x00430033, x55557777, x55167744, x5A19784B;\
 uint32_t x5A1987B4, x7A3BD7F5, x003B00F5, x221955A0, x05050707, x271C52A7;\
 uint32_t x2A2A82A0, x6969B193, x1FE06F90, x16804E00, xE97FB1FF;\
 uint32_t x43403302, x35CAED30, x37DEFFB7, x349ECCB5, x0B01234A;\
 uint32_t x101884B4, x0FF8EB24, x41413333, x4FF9FB37, x4FC2FBC2;\
 uint32_t x43E9BBC2, x16BCEE97, x0F080B04, x19B4E593;\
 uint32_t x5C5C5C5C, x4448184C, x2DDABE71, x6992A63D;\
 uint32_t x00, x01, x10, x11, x20, x21, x30, x31;\
 x77777777 = a1 | a3;\
...
{\
 uint32_t x33CC33CC;\
 uint32_t x3333FFFF, x11115555, x22DD6699, x22DD9966, x00220099;\
 uint32_t x00551144, x33662277, x5A5A5A5A, x7B7E7A7F, x59A31CE6;\
 uint32_t x09030C06, x09030000, x336622FF, x3A6522FF;\
 uint32_t x484D494C, x0000B6B3, x0F0FB9BC, x00FC00F9, x0FFFB9FD;\
 uint32_t x7B7B7B7B, x411E5984, x1FFFFDFD, x5EE1A479;\
 uint32_t x5DF75DF7, x116600F7, x1E69B94B, x1668B94B;\
 uint32_t x3CB4DFD2, x004B002D, x33363237, xCCC9CDC8, xCC82CDE5;\
 uint32_t x0055EEBB, x5A5AECE9, x0050ECA9, xC5CAC1CE, xC59A2D67;\
 uint32_t x00, x01, x10, x11, x20, x21, x30, x31;\
 x33CC33CC = a2 ^ a5;\
 x3333FFFF = a2 | a6;\
...
{\
 uint32_t x0FF00FF0, x3CC33CC3, x00003CC3, x0F000F00, x5A555A55, x00001841;\
 uint32_t x00000F00, x33333C33, x7B777E77, x0FF0F00F, x74878E78;\
 uint32_t x003C003C, x5A7D5A7D, x333300F0, x694E5A8D;\
 uint32_t x0FF0CCCC, x000F0303, x5A505854, x33CC000F, x699C585B;\
 uint32_t x0FF0C0CC, x0FFFC3CF, x2E222B22, x28000802, x27FFCBCD;\
 uint32_t x48444844, x4FF4C8CC, x6F9C5F5B, x4F944848, x686B8385;\
 uint32_t x6FFFDBCF, x6FC3DBF3, x0000DBF3, x4F9493BB;\
 uint32_t x00005151, x96B1A572, x96B1F423, xD9256798;\
 uint32_t x00, x01, x10, x11, x20, x21, x30, x31;\
 x0FF00FF0 = a4 ^ a5;\
...
{\
 uint32_t x0C0C0C0C, x0000F0F0, x00FFF00F, x00555005, x00515001;\
 uint32_t x33000330, x77555775, x30303030, x3030CFCF, x30104745, x30555745;\
 uint32_t xFF000FF0, xCF1048B5, x080A080A, xC71A40BF, xCB164CB3;\
 uint32_t xF429738C, xC72970BC, x9E4319E6, x000019E6, xC729695A;\
 uint32_t xF77C3E1F, xF77F3F3F, x9E43E619, x693CD926;\
 uint32_t xF719A695, xF4FF73FF, x03E6D56A, x56B3803F;\
 uint32_t xF700A600, x61008000, x03B7856B, x62B7056B;\
 uint32_t x00, x01, x10, x11, x20, x21, x30, x31;\
 x0C0C0C0C = a3 & ~a2;\
 x0000F0F0 = a5 & ~a3;\
